								...
								<div class="sqw-full-width">
									...
									<div class="sqw-tiers">
										<div class="sqw-padding-left">
											...
											<div class="sqw-margin-top">
												<input class="sqw-radio" id="blue" type="radio" name="btheme" value="blue" <?php echo ($btheme == 'blue' ? 'checked' : '') ?>/><label for="blue" ><?php _e('Blue'); ?></label>
											</div>
											<div class="sqw-margin-top">
												<input class="sqw-radio" id="grey" type="radio" name="btheme" value="grey" <?php echo ($btheme == 'grey' ? 'checked' : '') ?>/><label for="grey"><?php _e('Grey'); ?></label>
											</div>
											<!--<div class="sqw-margin-top">
