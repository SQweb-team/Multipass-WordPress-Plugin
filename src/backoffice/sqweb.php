				...
				<div class="sqw-box sqw-right">
					<div>
						...
						<div class="sqw-body sqw-customize-btn-split-half">
							...
							<div class="sqweb-button-support multipass-tiny sqw-margin-top">
								<div class="sqw-btn-mp">
									<input name="sqw_btn_login_tiny" type="text" class="sqw-btn-mp-link sqw-btn-mp-link-tiny-only sqw-input-customize-btn sqw-input-customize-btn-tiny" value="<?php
										echo get_option( 'sqw_btn_login_tiny' ) != '' ?
										get_option( 'sqw_btn_login_tiny' ) :
										_e( 'Premium', 'sqweb' );
									?>"
									maxlength="7">
								</div>
						...
						<div class="sqw-body sqw-customize-btn-split-half">
							...
							<div class="sqweb-button-support multipass-tiny sqw-margin-top">
								<div class="sqw-btn-mp">
									<input name="sqw_btn_connected_tiny" type="text" class="sqw-btn-mp-link sqw-btn-mp-link-tiny-only sqw-input-customize-btn sqw-input-customize-btn-tiny" value="<?php
										echo get_option( 'sqw_btn_connected_tiny' ) != '' ?
										get_option( 'sqw_btn_connected_tiny' ) :
										_e( 'Premium', 'sqweb' );
									?>"
									maxlength="7">
						...
						<div class="sqw-body">
							...
							<div class="sqweb-button-support sqw-margin-top">
								<div class="sqw-btn-mp">
									...
									<input name="sqw_btn_login" type="text" class="sqw-btn-mp-link sqw-btn-mp-link-tiny-none sqw-input-customize-btn sqw-input-customize-btn-regular sqw-input-customize-btn-regular-logged-out" value="<?php
										echo get_option( 'sqw_btn_login' ) != '' ?
										get_option( 'sqw_btn_login' ) :
										_e( 'Premium with Multipass', 'sqweb' );
									?>"
									maxlength="28">
								</div>
							</div>
						...
						<div class="sqw-body">
							...
							<div class="sqweb-button-support sqw-margin-top">
								<div class="sqw-btn-mp">
									<span class="sqw-btn-mp-logo"></span>
									<input name="sqw_btn_connected" type="text" class="sqw-btn-mp-link sqw-btn-mp-link-tiny-none sqw-input-customize-btn sqw-input-customize-btn-regular" value="<?php
										echo get_option( 'sqw_btn_connected' ) != '' ?
										get_option( 'sqw_btn_connected' ) :
										_e( 'Logged in with Multipass', 'sqweb' );
									?>"
									maxlength="25">
									<a class="sqw-btn-mp-logout"></a>
								</div>
						...
						<div class="sqw-body">
							...
							<div class="sqweb-button-support sqw-margin-top">
								<div class="sqw-btn-mp">
									<span class="sqw-btn-mp-logo"></span>
									<input name="sqw_btn_support" type="text" class="sqw-btn-mp-link sqw-btn-mp-link-tiny-none sqw-input-customize-btn sqw-input-customize-btn-regular sqw-input-customize-btn-regular-logged-out" value="<?php
										echo get_option( 'sqw_btn_support' ) != '' ?
										get_option( 'sqw_btn_support' ) :
										_e( 'Support us with Multipass', 'sqweb' );
									?>"
									maxlength="28">
								</div>
							</div>
						...
						<div class="sqw-body">
							...
							<div class="sqweb-button-support sqw-margin-top">
								<div class="sqw-btn-mp">
									<span class="sqw-btn-mp-logo"></span>
									<input name="sqw_btn_connected_support" type="text" class="sqw-btn-mp-link sqw-btn-mp-link-tiny-none sqw-input-customize-btn sqw-input-customize-btn-regular" value="<?php
										echo get_option( 'sqw_btn_connected_support' ) != '' ?
										get_option( 'sqw_btn_connected_support' ) :
										_e( 'Support us with Multipass', 'sqweb' );
									?>"
									maxlength="25">
									<a class="sqw-btn-mp-logout"></a>
							...
							<div class="sqweb-button multipass-large sqw-margin-top">
								<div class="sqw-btn-mp">
									...
									<span class="sqw-btn-mp-link sqw-btn-mp-link-large-only">
										...
										<br>
										<input name="sqw_btn_unlimited" type="text" class="sqw-input-customize-btn sqw-input-customize-btn-large-before-dot" value="<?php
											echo get_option( 'sqw_btn_unlimited' ) != '' ?
											get_option( 'sqw_btn_unlimited' ) :
											_e( 'Unrestricted access', 'sqweb' );
										?>"
										maxlength="16">
										<span style="margin-left: -2px;">•</span>
										<input name="sqw_btn_noads" type="text" class="sqw-input-customize-btn sqw-input-customize-btn-large-after-dot" value="<?php
											echo get_option( 'sqw_btn_noads' ) != '' ?
											get_option( 'sqw_btn_noads' ) :
											_e( 'No ads', 'sqweb' );
										?>" maxlength="11">
									</span>
								</div>
							...
							<div class="sqweb-button multipass-large sqw-margin-top">
								<div class="sqw-btn-mp">
									...
									<span class="sqw-btn-mp-link sqw-btn-mp-link-large-only">
										<b><?php echo ( get_option( 'blogname' ) ) ?> PREMIUM</b>
										<br>
										<input name="sqw_btn_connected_s" type="text" class="sqw-input-customize-btn sqw-input-customize-btn-large-logged-in" value="<?php
											echo get_option( 'sqw_btn_connected_s' ) != '' ?
											get_option( 'sqw_btn_connected_s' ) :
											_e( 'Logged in', 'sqweb' );
										?>"
										maxlength="25">
									</span>
