...
/*-------------------------------------------------------------
 ...
 Since:		0.8
-------------------------------------------------------------*/
class adrotate_widgets_sqw_compatibility extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			'classname' => 'adrotate_widgets_sqw_compatibility',
			'description' => 'Show a group of adverts or a single advert in any widget area.',
		);
		parent::__construct('adrotate_widgets_sqw_compatibility', 'AdRotate SQweb compatibility', $widget_ops);
	}
