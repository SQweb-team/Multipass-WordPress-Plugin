...
class SQweb_Filter_Articles {
	...
	public function msg_restrict_cut_art_perc() {
		//V1 bouton
		return '<div onclick="sqw.modal_first(event)" class="sqw-paywall-button-container"><h5>' . __( 'The rest of this article is for subscribers only', 'sqweb' ) . '</h5><div><img src="' . plugin_dir_url( __FILE__ ) . '../resources/img/multipass_logo@2x.png' . '"></div><span>' . __( 'Become a subscriber now', 'sqweb' ) . '</span></div>';

		//V2 bouton
		return '<div class="footer__mp__normalize footer__mp__button_container">
					<div class="footer__mp__button_header">
						<div onclick="sqw.modal_first(event)" class="footer__mp__button_header_title">' . __( 'The rest of this article is restricted', 'sqweb' ) . '</div>
						<div onclick="sqw.modal_first(event)" class="footer__mp__button_signin">' . __( 'Already premium? ', 'sqweb' ) . '<span class="footer__mp__button_login footer__mp__button_strong">' . __( 'Sign in', 'sqweb' ) . '</span></div>
					</div>
	...
	public function msg_restrict_art_by_day() {
		...
		return '<div class="footer__mp__normalize footer__mp__button_container">
					<div class="footer__mp__button_header">
						...
						<div onclick="sqw.modal_first(event)" class="footer__mp__button_signin">' . __( 'Already premium? ', 'sqweb' ) . '<span onclick="sqw.modal_first(event)" class="footer__mp__button_login footer__mp__button_strong">' . __( 'Sign in', 'sqweb' ) . '</span></div>
					</div>
					<div onclick="sqw.modal_first(event)" class="footer__mp__normalize footer__mp__button_cta">
						<a href="#" class="footer__mp__cta_fresh">' . __( 'Unlock this article, get your', 'sqweb' ) . '</a>
					</div>
