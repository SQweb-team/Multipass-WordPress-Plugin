...
function sqw_support_button_html() {
	return '<div class="article-footer-container">
					<div class="article-footer-body">
					<div class="article-footer-body-title">'
						. __( 'Continue reading...', 'sqweb' )
					. '</div>
					<div class="article-footer-body-content1">'
					...
					. '</div>
					<div class="article-footer-body-content2">'
					...
					. '</div>
					<div class="article-footer-body-content3">'
				...
				<div onclick="sqw.modal_first()" class="article-footer-footer">
					<div class="article-footer-footer-text">
						<span class="article-footer-footer-bold">'
